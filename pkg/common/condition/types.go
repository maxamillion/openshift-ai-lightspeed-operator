...
const (
	...
	// SeverityNone should apply to conditions with `Status=True`.
	SeverityNone Severity = ""
)

// Type is a condition type
type Type string

// Reason is a condition reason
type Reason string
...
type Condition struct {
	...
	// and target condition is not reachable).
	// +optional
...
// conditionGroup groups conditions by status and severity
